...
const Services = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        const res = await axios.put(`${backendUrl}/api/services/${editingId}`, data, { withCredentials: true });
        if (res.data.success) {
          MySwal.fire({
            title: 'Updated',
        ...
        const res = await axios.post(`${backendUrl}/api/services`, data, { withCredentials: true });
        if (res.data.success) {
          MySwal.fire({
            title: 'Created',
